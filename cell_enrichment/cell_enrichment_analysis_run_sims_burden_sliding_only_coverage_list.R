...
for(panel in c(levels(as.factor(panel_data$Panel)),"all")){
    ...
    write.table(simulations_summary,paste0("burden_sliding_enrichment_simulations_list_",panel,"_",sim_start),quote=F,row.names=F)
}